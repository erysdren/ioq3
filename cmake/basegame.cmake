if(NOT BUILD_GAME_LIBRARIES AND NOT BUILD_GAME_QVMS AND NOT BUILD_GAME_STATIC)
    return()
endif()
...
if(BUILD_GAME_STATIC)
    ...
    set(GAME_MODULE_BINARY_BASEGAME ${GAME_MODULE_BINARY}_${BASEGAME})
    set(UI_MODULE_BINARY_BASEGAME ${UI_MODULE_BINARY}_${BASEGAME})
    set(GAME_MODULE_LIBRARIES ${CGAME_MODULE_BINARY_BASEGAME} ${GAME_MODULE_BINARY_BASEGAME} ${UI_MODULE_BINARY_BASEGAME})

    add_library(                ${CGAME_MODULE_BINARY_BASEGAME} STATIC ${CGAME_SOURCES_BASEGAME} ${CGAME_BINARY_SOURCES})
    target_compile_definitions( ${CGAME_MODULE_BINARY_BASEGAME} PRIVATE CGAME Q3_VM_STATIC)
    target_link_libraries(      ${CGAME_MODULE_BINARY_BASEGAME} PRIVATE ${COMMON_LIBRARIES})

    add_library(                ${GAME_MODULE_BINARY_BASEGAME} STATIC ${GAME_SOURCES_BASEGAME} ${GAME_BINARY_SOURCES})
    target_compile_definitions( ${GAME_MODULE_BINARY_BASEGAME} PRIVATE QAGAME Q3_VM_STATIC)
    target_link_libraries(      ${GAME_MODULE_BINARY_BASEGAME} PRIVATE ${COMMON_LIBRARIES})

    add_library(                ${UI_MODULE_BINARY_BASEGAME} STATIC ${UI_SOURCES_BASEGAME} ${UI_BINARY_SOURCES})
    target_compile_definitions( ${UI_MODULE_BINARY_BASEGAME} PRIVATE UI Q3_VM_STATIC)
    target_link_libraries(      ${UI_MODULE_BINARY_BASEGAME} PRIVATE ${COMMON_LIBRARIES})

    target_link_libraries(      ${CLIENT_BINARY} PRIVATE ${GAME_MODULE_LIBRARIES})
    target_compile_definitions( ${CLIENT_BINARY} PRIVATE Q3_VM_STATIC)
endif()
